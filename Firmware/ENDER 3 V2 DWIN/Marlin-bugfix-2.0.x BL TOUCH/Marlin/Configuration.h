...
#define STRING_CONFIG_H_AUTHOR "LMoesman" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -55, -33.5, 0 }
...
// Setting the LCD_SERIAL_PORT to 1 will enable the TX1 and RX1 pins on the TFT header
